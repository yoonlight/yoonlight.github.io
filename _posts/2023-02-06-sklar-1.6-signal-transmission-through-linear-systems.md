...
![width:800px center](images/linear-system.png)
...
![center](images/ideal-bandpass-filter.png)
...
![center](images/ideal-low-pass-filter.png)
...
![center](images/ideal-high-pass-filter.png)
...
![width:600px center](images/impulse_response-of-the_ideal_low_pass_filter.png)
...
![center](images/rc_filter-magitude_characteristic.png)

---

- Phase characteristic of the RC filter

![center](images/rc_filter-phase_characteristic.png)
...
$$
![width:500px center](images/butterworth_filter-magnitude_response.png)
...
![center](images/output_bandwidth-constrained_by_input_signal.png)

---

The bandwidth of the output signal constrained by the filter bandwidth

![center](images/output_bandwidth-constrained_by_filter_bandwidth.png)
...
![center](images/ideal-pulse.png)

---

Magnitude spectrum of the ideal input pulse $|X(f)|$

![center](images/magnitude-spectrum-of-the-ideal-pulse.png)

---

Good-fidelity ouput

![center](images/good-fidelity.png)
...
![center](images/good-recognition.png)
...
![center](images/poor-recognition.png)
